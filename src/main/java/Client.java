...
public class Client {
    private static final String URL = "rmi://THANHNGHIEM:4501/";
            ...
            while (true) {
                ...
                switch (option) {
                    case 1:
                        ...
                        break;
                    case 2:
                        albumDao.getAllAlbums().forEach(x -> System.out.println(x));
                        break;
                    case 3:
                        ...
                        albumDao.listAlbumByGenre(genre, year).forEach(x -> System.out.println(x));
                        break;
                    case 4:
